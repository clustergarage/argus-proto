...
func (*FimdConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_fim_c86b85db1aa93dd6, []int{0}
}
...
func (*FimWatcherSubject) Descriptor() ([]byte, []int) {
	return fileDescriptor_fim_c86b85db1aa93dd6, []int{1}
}
...
func (*FimdHandler) Descriptor() ([]byte, []int) {
	return fileDescriptor_fim_c86b85db1aa93dd6, []int{2}
}
...
type FimdClient interface {
	NewWatcher(ctx context.Context, in *FimdConfig, opts ...grpc.CallOption) (*FimdHandler, error)
}
...
func (c *fimdClient) NewWatcher(ctx context.Context, in *FimdConfig, opts ...grpc.CallOption) (*FimdHandler, error) {
	out := new(FimdHandler)
...
type FimdServer interface {
	NewWatcher(context.Context, *FimdConfig) (*FimdHandler, error)
}
...
func _Fimd_NewWatcher_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FimdServer).NewWatcher(ctx, req.(*FimdConfig))
	}
...
func init() { proto.RegisterFile("fim.proto", fileDescriptor_fim_c86b85db1aa93dd6) }

var fileDescriptor_fim_c86b85db1aa93dd6 = []byte{
	...
	0x9c, 0xc7, 0x1a, 0xc4, 0x94, 0x99, 0x62, 0x64, 0xc9, 0xc5, 0x02, 0x92, 0x16, 0x32, 0xe4, 0xe2,
	0xf2, 0x4b, 0x2d, 0x87, 0xda, 0x24, 0xc4, 0x0f, 0x73, 0x19, 0xd4, 0x7b, 0x52, 0x02, 0x70, 0x01,
	0xa8, 0x41, 0x4a, 0x0c, 0x49, 0x6c, 0xe0, 0xc0, 0x30, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x66,
	0x09, 0x05, 0x44, 0x19, 0x01, 0x00, 0x00,
}
